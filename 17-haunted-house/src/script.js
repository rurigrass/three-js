...
gui.add(fog, "far").min(1).max(50).step(1).name("fog far");
...
// this below is for the ambientocclusion
...
const roof = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({ color: "#b35f45", roughness: 0.3 })
);
...
const graveMaterial = new THREE.MeshStandardMaterial({ color: "#dddddd" });
